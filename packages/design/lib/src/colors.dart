...
class ColorsWeebi {
  ...
  /// Supplier payments / spend covered — orange-red, closer to spending than amber.
  static const orangeSpendCover = Color(0xFFE64A19);
  ...
  /// OHADA SMT chrome: Weebi blue + dark gold (distinct from Suivi purple).
  static const ohadaBlue = blueWeebi;
  static const ohadaGold = Color(0xFF9A7A2F);
  static const ohadaSurface = Color(0xFFEFF3F8);
