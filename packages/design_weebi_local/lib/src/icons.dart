...
abstract class IconsWeebi {
  ...
  static final accounting = FontAwesomeIcons.calculator.data;
  static final chartsFinancial = FontAwesomeIcons.chartPie.data;
  ...
  static final scanBarcodeIcondata = FontAwesomeIcons.barcode.data;
